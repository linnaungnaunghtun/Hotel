function Footer() {
    ...
    return (
    <>
    <div className="md:w-full  rounded-3xl p-8 w-3/4">
    <div className="gap-14 w-full justify-between md:flex md:w-full">
          <div className="flex-1">
            <div className="max-w-xs md:max-w-7xl">
            ...
            <form>
              ...
              <div className="max-w-sm flex items-center border rounded-3xl p-2">
                <input
                  type="email"
        ...
        <div className="mt-8 py-6 border-t items-center justify-between sm:flex">
          <div className="mt-4 sm:mt-0">
            &copy; 2022 Flash UI All rights reserved.
          </div>
